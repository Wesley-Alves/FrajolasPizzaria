<?php
    ...
    require_once("../controller/sobre_nos_controller.php");
    ...
    $sobreNos = $sobreNosDao->getSobreNos(false);
        ...
        <div id="main">
            ...
            <div id="content">
                ...
                <div id="tabela">
                    ...
                    <div id="tabela_body">
                        <?php
                            foreach ($sobreNos as $sobreNosItem) {
                                $sobreNosController->montarHtmlAdm($sobreNosItem);
                            }
                        ?>
                    </div>
                </div>
